        ...
        <AuthProvider>
          ...
          <footer className="mt-20 bg-[#10243d] text-white">
            <div className="max-w-7xl mx-auto px-5 py-12 grid md:grid-cols-3 gap-10">
              ...
              <div>
                <div className="text-xs uppercase tracking-[.16em] text-[#c9a44b] font-bold mb-4">Popular services</div>
                <div className="space-y-2 text-sm text-slate-300">
                  <Link className="block hover:text-white transition-colors" href="/report-incident">Report an incident</Link>
                  <Link className="block hover:text-white transition-colors" href="/certificate">Request a certificate</Link>
                  <Link className="block hover:text-white transition-colors" href="/track">Track an application</Link>
                </div>
              </div>
              <div>
                <div className="text-xs uppercase tracking-[.16em] text-[#c9a44b] font-bold mb-4">Public notice</div>
                <p className="text-sm text-slate-300 leading-6">
