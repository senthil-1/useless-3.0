...
export default function LoginPage() {
  ...
  const handleLogin = (event: FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      alert(
        "LOGIN RECEIVED\n\n" +
          "The Ministry has acknowledged your existence.\n\n" +
  ...
  const handleGoogleLogin = () => {
    alert(
      "GOOGLE AUTHENTICATION\n\n" +
        "Google Sign-In will be connected here once the Google " +
        "provider is enabled in Firebase Authentication."
    );
  };
  ...
  const handleForgotPassword = () => {
    ...
    alert(
      "PASSWORD RECOVERY\n\n" +
        `A password reset request has been prepared for:\n${email}\n\n` +
            ...
            <div className="mt-7 max-w-[650px] overflow-hidden rounded-xl border-2 border-[#172235] bg-[#fffaf0] shadow-[6px_6px_0_#172235]">
              ...
              <div className="flex h-11 items-center justify-between bg-[#172235] px-5">
                ...
                <span className="text-[9px] font-bold text-white/40">
                  NOTICE #{String(quoteIndex + 1).padStart(3, "0")}
                </span>
            ...
            <div className="overflow-hidden rounded-2xl border-2 border-[#172235] bg-[#fffaf0] shadow-[9px_9px_0_#172235]">
              ...
              <div className="px-7 py-6 sm:px-8 sm:py-7">
                ...
                <form onSubmit={handleLogin}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="h-14 w-full rounded-lg border-2 border-[#172235] bg-white px-5 text-[15px] font-medium tracking-wide outline-none transition placeholder:text-[#9ca3ad] focus:bg-[#fff8d9] focus:shadow-[4px_4px_0_#e8c878]"
                    />
                  ...
                  <div className="mt-5">
                    ...
                    <div className="mb-2.5 flex items-center justify-between gap-3">
                      ...
                      <button
                        ...
                        className="shrink-0 text-[9px] font-bold text-[#9b1c31] underline underline-offset-3"
                      >
                        Forgot password?
                      </button>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="h-14 w-full rounded-lg border-2 border-[#172235] bg-white px-5 pr-20 text-[15px] font-medium tracking-wide outline-none transition placeholder:text-[#9ca3ad] focus:bg-[#fff8d9] focus:shadow-[4px_4px_0_#e8c878]"
                      />
                      ...
                      <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 rounded-md px-2 py-1 text-[9px] font-black uppercase transition hover:bg-[#eee8dc]"
                      >
                        {showPassword
                          ? "Hide"
                          : "Show"}
                ...
                <button
                  ...
                  className="flex h-14 w-full items-center justify-center gap-3 rounded-lg border-2 border-[#172235] bg-white text-[13px] font-bold shadow-[4px_4px_0_#d5d0c5] transition hover:bg-[#f5f5f5] hover:shadow-[5px_5px_0_#172235] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
                >
                ...
                <p className="mt-2.5 text-center text-[8px] leading-4 text-[#9a9fa7]">
                  Google authentication becomes active when the
