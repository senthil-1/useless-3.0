    ...
    if (!agree) {
      alert(
        "DECLARATION REQUIRED\n\n" +
          "Please confirm that you have read and accepted the Ministry's "
          +
          "completely reasonable terms and conditions."
      );
    ...
    setTimeout(() => {
      ...
      alert(
        "APPLICATION SUBMITTED\n\n" +
          "Congratulations, distinguished citizen.\n\n" +
          "Your citizenship application has been successfully received.\n\n" +
            ...
            <div className="mt-7 max-w-[600px] overflow-hidden rounded-xl border-2 border-[#172235] bg-[#fffaf0] shadow-[6px_6px_0_#172235]">
              ...
              <div className="px-6 py-5">
                ...
                <p className="font-serif text-[19px] font-bold leading-7">
                  “Citizenship comes with absolutely no
                  responsibilities that we can clearly define.”
                </p>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-[1fr_150px]">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="h-12 w-full rounded-lg border-2 border-[#172235] bg-white px-4 text-[13px] outline-none transition placeholder:text-[#9ca3ad] focus:bg-[#fff8d9] focus:shadow-[3px_3px_0_#e8c878]"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="h-12 w-full rounded-lg border-2 border-[#172235] bg-white px-3 text-[12px] outline-none transition focus:bg-[#fff8d9] focus:shadow-[3px_3px_0_#e8c878]"
                      />
                  ...
                  <div className="mt-4">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="h-12 w-full rounded-lg border-2 border-[#172235] bg-white px-4 pr-16 text-[13px] outline-none transition placeholder:text-[#9ca3ad] focus:bg-[#fff8d9] focus:shadow-[3px_3px_0_#e8c878]"
                      />
                  ...
                  <div className="mt-4">
                    ...
                    <select
                      ...
                      className="h-12 w-full rounded-lg border-2 border-[#172235] bg-white px-4 text-[12px] outline-none transition focus:bg-[#fff8d9] focus:shadow-[3px_3px_0_#e8c878]"
                    >
                  ...
                  <div className="mt-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <label
                        className={`flex h-11 cursor-pointer items-center justify-center rounded-lg border-2 text-[10px] font-black uppercase tracking-wider transition ${
                          experiencedBureaucracy === "yes"
